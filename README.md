...
- Supports Groth16, PLONK, and FFLONK proving systems
- High performance with WebAssembly implementation
- Compatible with circom compiler
- ES module support for modern build systems

## System Requirements

- **Node.js**: v18.0.0 or later (LTS version recommended)
- **Memory**: Minimum 4GB RAM (8GB+ recommended for larger circuits)
- **Storage**: Depends on circuit size, minimum 1GB free space recommended
- **Operating System**: Windows 10+, macOS 10.15+, or Linux
- **Browser** (for web usage): Modern browser with WebAssembly support
...
Here's a simple example to get you started with snarkjs:
...
async function generateAndVerifyProof() {
    ...
    const { proof, publicSignals } = await snarkjs.groth16.fullProve(
        { a: 3, b: 11 }, // Circuit inputs
        "circuit.wasm",   // WASM file
...
### 1. Memory Issues
When working with large circuits, you may encounter memory issues. Try:
- Increasing Node.js memory limit: `node --max-old-space-size=8192 your-script.js`
- Using smaller batch sizes for witness generation
- Running in single-thread mode for memory-constrained environments

### 2. Performance Optimization
For better performance:
- Use WebAssembly when possible
- Enable worker threads for parallel computation
- Consider using PLONK for smaller circuits
...
- Ensure proper format of input data
- Validate circuit constraints

For more detailed solutions and examples, visit our [GitHub Issues](https://github.com/iden3/snarkjs/issues) page.
...
- [snarkjs Tutorial](https://blog.iden3.io/first-zk-proof.html)
- [Circom & snarkjs Workshop](https://github.com/0xPARC/zk-learning-group)

### Video Tutorials
- [Introduction to ZK-SNARKs with Circom and snarkjs](https://www.youtube.com/watch?v=9s1VlwFyj5w)
- [Building Zero Knowledge Applications](https://www.youtube.com/watch?v=RxL_1AfV7N4)
- [Zero Knowledge Proof Programming](https://www.youtube.com/watch?v=9VXb-XKwF80)
...
### Community Resources
- [Zero Knowledge Forum](https://community.zkproof.org/)
- [ZK Hack Discord](https://discord.gg/tHXyB4b9xE)
- [Telegram Discussion Group](https://t.me/iden3io)
...
- [Telegram Group](https://t.me/iden3io)
- [Twitter](https://twitter.com/iden3io)
- [GitHub Discussions](https://github.com/iden3/snarkjs/discussions)
