...
async function fflonkProve(zkeyFileName, witnessFileName, logger) {
    ...
    return {
        proof: stringifyBigInts$4(_proof),
...
async function fflonkProveCmd(zkeyFilename, witnessFilename, publicInputsFilename, proofFilename, logger) {
    ...
    if(undefined !== proofFilename && undefined !== publicInputsFilename) {
        await bfj__default["default"].write(proofFilename, stringifyBigInts$3(proof), {space: 1});
        await bfj__default["default"].write(publicInputsFilename, stringifyBigInts$3(publicSignals), {space: 1});
    }
...
async function fflonkFullProveCmd(zkeyFilename, witnessInputsFilename, wasmFilename, publicInputsFilename, proofFilename, logger) {
    ...
    input = unstringifyBigInts$6(input);
    ...
    await bfj__default["default"].write(proofFilename, stringifyBigInts$2(proof), {space: 1});
    await bfj__default["default"].write(publicInputsFilename, stringifyBigInts$2(publicSignals), {space: 1});
...
async function fflonkVerify(_vk_verifier, _publicSignals, _proof, logger) {
    ...
    _vk_verifier = unstringifyBigInts$5(_vk_verifier);
...
const {unstringifyBigInts: unstringifyBigInts$4, stringifyBigInts: stringifyBigInts$1} = ffjavascript.utils;
...
async function fflonkExportSolidityVerifier(vk, templates, logger) {
    ...
    function fromVkey(str) {
        const val = unstringifyBigInts$4(str);
...
var fflonk_cmds = /*#__PURE__*/Object.freeze({
    __proto__: null,
    fflonkSetupCmd: fflonkSetupCmd,
    fflonkProveCmd: fflonkProveCmd,
    fflonkFullProveCmd: fflonkFullProveCmd,
    fflonkVerifyCmd: fflonkVerifyCmd,
    fflonkExportSolidityVerifierCmd: fflonkExportSolidityVerifierCmd,
    fflonkExportCallDataCmd: fflonkExportCallDataCmd
});
