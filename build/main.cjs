...
/*
    ...
    along with snarkJS. If not, see <https://www.gnu.org/licenses/>.
*/
const { unstringifyBigInts: unstringifyBigInts$d} = ffjavascript.utils;
...
const { unstringifyBigInts: unstringifyBigInts$9, leInt2Buff: leInt2Buff$1 } = ffjavascript.utils;
...
function convertVkToRustFormat(vk) {
    const vkData = unstringifyBigInts$9(vk);
...
const { unstringifyBigInts: unstringifyBigInts$8, leInt2Buff } = ffjavascript.utils;
...
var groth16 = /*#__PURE__*/Object.freeze({
    ...
    exportRustVerifier: groth16ExportRustVerifier,
    exportRustCallData: groth16ExportRustCallData
});
