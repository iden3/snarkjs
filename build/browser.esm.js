...
var ae = 65536;
async function oe(e) {
	let t = e.url, n = e.cache ? await re({
		fileKey: t,
		options: e.cache
...
async function zt(e, t) {
	...
	await e.writeULE32(a), await Oe(e, i, a), await e.writeULE32(s), await Oe(e, o, s), await e.writeULE32(t.nVars), await e.writeULE32(t.nPublic), await e.writeULE32(t.domainSize), await Bt(e, n, t.vk_alpha_1), await Bt(e, n, t.vk_beta_1), await Vt(e, n, t.vk_beta_2), await Vt(e, n, t.vk_gamma_2), await Bt(e, n, t.vk_delta_1), await Vt(e, n, t.vk_delta_2), await z(e);
}
...
async function Ut(e, t, n, r) {
	...
	if (await V(e), i === 1) return await Wt(e, t, n, r);
	if (i === 2) return await Gt(e, t, n, r);
	if (i === 10) return await Kt(e, t, n, r);
...
async function Kt(e, t, n, r) {
	...
	let o = await e.readULE32();
	return i.n8r = o, i.r = await ke(e, o), i.nVars = await e.readULE32(), i.nPublic = await e.readULE32(), i.domainSize = await e.readULE32(), i.power = wt(i.domainSize), i.nAdditions = await e.readULE32(), i.nConstraints = await e.readULE32(), i.k1 = await e.read(o), i.k2 = await e.read(o), i.w3 = await e.read(o), i.w4 = await e.read(o), i.w8 = await e.read(o), i.wr = await e.read(o), i.X_2 = await Ht(e, i.curve, n), i.C0 = await J(e, i.curve, n), await V(e), i;
}
async function qt(e, t) {
	let { fd: i, sections: a } = await L(e, "zkey", 1), o = await Ut(i, a, t), s = new n(o.r), c = r.mod(r.shl(1, o.n8r * 8), o.r), l = s.inv(c), u = s.mul(l, l), d = await Le(o.q);
	await B(i, a, 3), o.IC = [];
...
async function Jt(e, t, n) {
	let r = { delta: {} };
	r.deltaAfter = await J(e, t, n), r.delta.g1_s = await J(e, t, n), r.delta.g1_sx = await J(e, t, n), r.delta.g2_spx = await Ht(e, t, n), r.transcript = await e.read(64), r.type = await e.readULE32();
...
async function Xt(e, t, n) {
	await Bt(e, t, n.deltaAfter), await Bt(e, t, n.delta.g1_s), await Bt(e, t, n.delta.g1_sx), await Vt(e, t, n.delta.g2_spx), await e.write(n.transcript), await e.writeULE32(n.type || 0);
	let r = [];
	if (n.name) {
		r.push(1);
...
async function Zt(e, t, n) {
	...
	for (let r = 0; r < n.contributions.length; r++) await Xt(e, t, n.contributions[r]);
	await z(e);
}
function Qt(e, t, n) {
	let r = new Uint8Array(t.G1.F.n8 * 2);
...
function en(e, t, n) {
	Qt(e, t, n.deltaAfter), Qt(e, t, n.delta.g1_s), Qt(e, t, n.delta.g1_sx), $t(e, t, n.delta.g2_spx), e.update(n.transcript);
}
//#endregion
...
async function an(e) {
	let { fd: t, sections: n } = await L(e, "wtns", 2), { n8: r, nWitness: i } = await rn(t, n);
	await B(t, n, 2);
	let a = [];
	for (let e = 0; e < i; e++) {
		let e = await ke(t, r);
...
var { stringifyBigInts: on } = s;
async function sn(e, t, n, r) {
	let i, a;
	try {
		let o = await L(t, "wtns", 2, 1 << 25, 1 << 23);
		i = o.fd;
		let s = await L(e, "zkey", 2, 1 << 25, 1 << 23);
		return a = s.fd, await cn(a, s.sections, i, o.sections, n, r);
	} finally {
		a && await Promise.resolve(a.close()).catch(() => {}), i && await Promise.resolve(i.close()).catch(() => {});
	}
}
async function cn(e, t, n, i, a, o) {
	let s = await rn(n, i), c = await Ut(e, t, void 0, o);
	...
	let v = await U(n, i, 2), y = (n) => {
		...
		await (async function() {
			...
			let s = await U(e, t, 4);
			if (a && a.debug("Building ABC"), o.buildABC === "js") [n, r, i] = await ln(l, c, v, s, a);
			else {
				let e = un(l, c, s, o);
				a && a.debug(`buildABC: stream nChunks=${e.nChunks} maxInFlight=${e.maxInFlight}`), [n, r, i] = await dn(l, c, v, s, a, e.nChunks, e.maxInFlight);
			}
		})();
		/* c8 ignore start */
		...
		]), a && a.debug("Join ABC"), S = await fn(l, c, d, f, p, a), a && a.debug("Join ABC finished"), d = null, f = null, p = null;
	})(), w = {};
	async function T() {
	...
	return w.pi_a = d.toObject(d.toAffine(w.pi_a)), w.pi_b = f.toObject(f.toAffine(w.pi_b)), w.pi_c = d.toObject(d.toAffine(w.pi_c)), w.protocol = "groth16", w.curve = l.name, w = on(w), F = on(F), {
		proof: w,
		publicSignals: F
	};
}
...
async function dn(t, n, r, i, a, o, s) {
...
function pn(e) {
	let t = e.initialSize || 1 << 20, n = new yn();
	return n.o = e, n.o.data = new Uint8Array(t), n.allocSize = t, n.totalSize = 0, n.readOnly = !1, n.pos = 0, n;
}
function mn(e) {
	let t = new yn();
...
function bn(e) {
	let t = e.initialSize || 0, n = new En();
	n.o = e;
...
var Sn = /* @__PURE__ */ new Uint8Array(4), Cn = new DataView(Sn.buffer), wn = /* @__PURE__ */ new Uint8Array(8), Tn = new DataView(wn.buffer), En = class {
	constructor() {
		this.pageSize = 16384;
	}
	_resizeIfNeeded(e) {
	...
	async writeULE32(e, t) {
		let n = this;
		Cn.setUint32(0, e, !0), await n.write(Sn, t);
	}
	async writeUBE32(e, t) {
		let n = this;
		Cn.setUint32(0, e, !1), await n.write(Sn, t);
	}
	async writeULE64(e, t) {
		let n = this;
		Tn.setUint32(0, e & 4294967295, !0), Tn.setUint32(4, Math.floor(e / 4294967296), !0), await n.write(wn, t);
	}
	async readULE32(e) {
		let t = await this.read(4, e);
		return new Uint32Array(t.buffer)[0];
...
}, Dn = 1 << 20, On = 8192, kn = class {
	constructor(e, t, n, r) {
		this.readRangeInto = e, this.totalSize = t, this.pos = 0, this.pageSize = r || On, this.maxPagesLoaded = Math.floor((n || Dn) / this.pageSize) + 1, this.pages = /* @__PURE__ */ new Map(), this.readOnly = !0;
	}
	_pageLen(e) {
		let t = e * this.pageSize;
		return Math.min(t + this.pageSize, this.totalSize) - t;
	...
	async readString(e) {
		...
		for (; n < t.totalSize;) {
			let e = Math.min(t.pageSize, t.totalSize - n), i = await t.read(e, n), a = i.indexOf(0);
			if (a >= 0) return r.push(i.subarray(0, a)), t.pos = n + a + 1, An(r);
			r.push(i), n += e;
		}
		return t.pos = n, An(r);
	}
...
var jn = 1 << 21, Mn = 1 << 29, Nn = "fastfile-http-cache", Pn = /* @__PURE__ */ new Map();
function Fn(e) {
	...
	return Pn.set(e, t), t.catch(() => Pn.delete(e)), t;
}
function In(e) {
	return new Promise((t, n) => {
		e.onsuccess = () => t(e.result), e.onerror = () => n(e.error);
...
async function zn(e, t) {
	let n = e.transaction(["files", "blocks"], "readwrite");
	n.objectStore("files").delete(t), n.objectStore("blocks").delete(Rn(t, 0, Infinity)), await Ln(n);
}
async function Bn(e, t, n, r, i, a) {
	let o = e.transaction(["files", "blocks"], "readwrite"), s = o.objectStore("files"), c = await In(s.get(t)), l = 0;
	c && c.validator === n && c.totalSize === r && c.blockSize === i ? l = c.bytes : c && o.objectStore("blocks").delete(Rn(t, 0, Infinity)), s.put({
		validator: n,
		totalSize: r,
		blockSize: i,
		bytes: l,
	...
	let u = e.transaction("files", "readonly"), d = u.objectStore("files"), [f, p] = await Promise.all([In(d.getAllKeys()), In(d.getAll())]);
	await Ln(u);
	let m = p.reduce((e, t) => e + t.bytes, 0);
	if (m <= a) return;
	let h = f.map((e, t) => ({
	...
	for (let t of h) {
		if (m <= a) break;
		await zn(e, t.key), m -= t.meta.bytes;
	}
}
async function Vn(e, t) {
	let { fileKey: n, validator: r, totalSize: i } = t, a = typeof t.options == "object" && t.options || {}, o = a.blockSize || jn, s = a.maxBytes || Mn, c = a.dbName || Nn;
	if (typeof indexedDB > "u" || !r) return e;
	let l;
	try {
		l = await Fn(c), await Bn(l, n, r, i, o, s);
	} catch {
		return e;
	}
	let u = !1;
	async function d(e, t) {
		let r = l.transaction("blocks", "readonly"), i = r.objectStore("blocks"), a = Rn(n, e, t), [o, s] = await Promise.all([In(i.getAllKeys(a)), In(i.getAll(a))]);
		await Ln(r);
		let c = /* @__PURE__ */ new Map();
		for (let e = 0; e < o.length; e++) c.set(o[e][1], s[e]);
		return c;
	...
	async function f(e) {
		if (!(u || e.length === 0)) try {
			let t = l.transaction(["files", "blocks"], "readwrite"), r = t.objectStore("blocks"), i = t.objectStore("files");
			for (let t of e) r.put(t.data, [n, t.index]);
			let a = await In(i.get(n));
			a && (a.bytes += e.reduce((e, t) => e + t.data.byteLength, 0), a.lastUsed = Date.now(), i.put(a, n)), await Ln(t);
		} catch {
			u = !0;
		}
	}
...
async function Hn(e) {
	let t = (typeof e.options == "object" && e.options || {}).dbName || Nn;
	if (typeof indexedDB > "u") return null;
	try {
		let n = (await Fn(t)).transaction("files", "readonly"), r = await In(n.objectStore("files").get(e.fileKey));
		return await Ln(n), r ? {
			validator: r.validator,
			totalSize: r.totalSize,
			blockSize: r.blockSize,
...
async function Un(e) {
	let { fileKey: t, validator: n, totalSize: r, data: i } = e, a = typeof e.options == "object" && e.options || {}, o = a.blockSize || jn, s = a.maxBytes || Mn, c = a.dbName || Nn;
	if (typeof indexedDB > "u" || !n) return !1;
	try {
		let e = await Fn(c);
		await Bn(e, t, n, r, o, s);
		let a = Math.ceil(r / o);
		for (let n = 0; n < a; n += 64) {
			let s = e.transaction("blocks", "readwrite"), c = s.objectStore("blocks");
			for (let e = n; e < Math.min(n + 64, a); e++) {
		...
		let l = e.transaction("files", "readwrite"), u = l.objectStore("files"), d = await In(u.get(t));
		return d && (d.bytes = r, d.lastUsed = Date.now(), u.put(d, t)), await Ln(l), !0;
	} catch {
		return !1;
	}
}
var Wn = 65536;
async function Gn(e) {
	let t = e.url, n = e.cache ? await Hn({
		fileKey: t,
		options: e.cache
	}) : null, r = { Range: "bytes=0-0" };
	n && n.validator && (n.validator[0] === "\"" || n.validator.indexOf("W/") === 0 ? r["If-None-Match"] = n.validator : r["If-Modified-Since"] = n.validator);
	...
	if (i.status === 304) return await rr(i), await Kn(t, n.validator, n.totalSize, e);
	if (i.status === 206) {
		let n = i.headers.get("content-range"), r = n ? /\/(\d+)\s*$/.exec(n) : null;
		if (r) {
			let n = parseInt(r[1]);
			return await i.arrayBuffer(), await Kn(t, Jn(i), n, e);
		}
		return await i.arrayBuffer(), await qn(t);
	}
	if (!i.ok && i.status !== 416) throw Error("HTTP " + i.status + " fetching " + t);
	if (i.status === 416) {
		let e = i.headers.get("content-range");
		return e && /\/0\s*$/.test(e) ? mn({
			type: "mem",
			data: /* @__PURE__ */ new Uint8Array()
		}) : await qn(t);
	}
...
async function Kn(e, t, n, r) {
	let i = null, a = async function(n, r, a, o) {
		...
		if (a + o > s.byteLength) throw Error(e + ": read past the end of the buffered body");
		n.set(s.subarray(a, a + o), r);
	}, o = Math.min(r.pageSize || Wn, Wn);
	return r.cache && (a = await Vn(a, {
		fileKey: e,
		validator: t,
		totalSize: n,
		options: r.cache
	})), new kn(a, n, r.cacheSize, o);
}
async function qn(e) {
	let t = await fetch(e);
	if (!t.ok) throw Error("HTTP " + t.status + " fetching " + e);
...
var Yn = 4, Xn = 0, Zn = [];
async function Qn(e) {
	for (; Xn >= Yn;) await new Promise((e) => Zn.push(e));
	Xn++;
	try {
		return await e();
	} finally {
...
var $n = {
	...
	backoffMs: 300,
	stallTimeoutMs: 1e4
}, er = (e) => new Promise((t) => setTimeout(t, e));
async function tr(e, t, n, r, i, a) {
	return Qn(async () => {
		for (let o = 0;; o++) try {
			return await nr(e, t, n, r, i, a);
		} catch (e) {
			if (e && (e.degradeToFull || e.permanent) || o >= $n.retries) throw e;
			await er($n.backoffMs * (1 << o));
		}
	});
}
async function nr(e, t, n, r, i, a) {
	let o = { Range: "bytes=" + i + "-" + (i + a - 1) };
	t && (o["If-Range"] = t);
	let s = typeof AbortController < "u" ? new AbortController() : null, c = null, l = () => {
		s && (c && clearTimeout(c), c = setTimeout(() => s.abort(/* @__PURE__ */ Error(e + ": no data for " + $n.stallTimeoutMs + "ms")), $n.stallTimeoutMs));
	}, u = () => {
		c && clearTimeout(c), c = null;
	};
	l();
	...
	let f = d.headers.get("content-range"), p = f ? /bytes\s+(\d+)-(\d+)\//.exec(f) : null;
	if (p && parseInt(p[1]) !== i) throw await rr(d), Error(e + ": server returned range starting at " + p[1] + ", requested " + i);
	let m = 0;
	try {
		if (d.body && typeof d.body.getReader == "function") {
			let t = d.body.getReader();
...
function ar(e) {
	let t = e.blob, n = async function(e, n, r, i) {
		...
		if (a.byteLength !== i) throw Error("short blob read (" + a.byteLength + "/" + i + " bytes at " + r + ")");
		e.set(new Uint8Array(a), n);
	}, r = Math.min(e.pageSize || ir, ir);
	return new kn(n, t.size, e.cacheSize, r);
}
function or() {
	throw Error("File I/O is not supported in the browser");
}
function sr(e) {
	return e instanceof Uint8Array ? {
		type: "mem",
		data: e
	} : (typeof e == "string" && or(), e);
}
function cr(e, t, n) {
	if (e.type === "file" && or(), e.type === "mem") return t(e);
	if (e.type === "bigMem") return n(e);
	throw Error("Invalid FastFile type: " + e.type);
}
function lr(e) {
	return cr(sr(e), pn, bn);
}
async function ur(e, t, n) {
	return e instanceof Uint8Array && (e = {
		...
		cacheSize: t,
		pageSize: n
	}), e.type === "http" ? await Gn(e) : e.type === "blob" ? ar(e) : cr(e, mn, xn);
}
//#endregion
...
var gr = class {
	...
	async _doCalculateWitness(e, t) {
		...
		if (n.forEach((t) => {
			let n = pr(t), i = parseInt(n.slice(0, 8), 16), a = parseInt(n.slice(8, 16), 16), o = dr(e[t]);
			...
			for (let e = 0; e < o.length; e++) {
				let t = mr(fr(o[e], this.prime), this.n32);
...
}, { unstringifyBigInts: vr } = s;
async function yr(e, t, n, r) {
	let i = vr(e), a = await ur(t), o = await a.read(a.totalSize);
	await a.close();
	let s = await hr(o, r);
	if (s.circom_version() === 1) {
		let e = await s.calculateBinWitness(i), t = await De(n, "wtns", 2, 2);
		try {
			await nn(t, e, s.prime);
		} finally {
			await t.close();
		}
	} else {
		let e = await s.calculateWTNSBin(i), t = await lr(n);
		try {
			await t.write(e);
		} finally {
			await t.close();
...
async function xr(e, t, n, r, i, a) {
	let o = br(e), s = { type: "mem" };
	return await yr(o, t, s, i), await sn(n, s, r, a);
}
//#endregion
//#region src/groth16_verify.js
var { unstringifyBigInts: Sr } = s;
async function Cr(e, t, n, i) {
	let a = Sr(e), o = Sr(n), s = Sr(t), c = await Re(a.curve), l = c.G1.fromObject(a.IC[0]), u = new Uint8Array(c.G1.F.n8 * 2 * s.length), d = new Uint8Array(c.Fr.n8 * s.length);
	if (!Er(c, s)) return i && i.error("Public inputs are not valid."), !1;
...
function Er(e, t) {
	for (let n = 0; n < t.length; n++) if (!Tr(e, t[n])) return !1;
	return !0;
}
//#endregion
//#region src/groth16_exportsoliditycalldata.js
var { unstringifyBigInts: Dr } = s;
function Or(e) {
	let t = e.toString(16);
...
async function kr(e, t) {
	let n = Dr(e), r = Dr(t), i = "";
	for (let e = 0; e < r.length; e++) i != "" && (i += ","), i += Or(r[e]);
	let a;
	return a = `[${Or(n.pi_a[0])}, ${Or(n.pi_a[1])}],[[${Or(n.pi_b[0][1])}, ${Or(n.pi_b[0][0])}],[${Or(n.pi_b[1][1])}, ${Or(n.pi_b[1][0])}]],[${Or(n.pi_c[0])}, ${Or(n.pi_c[1])}],[${i}]`, a;
}
//#endregion
//#region src/groth16.js
var Ar = /* @__PURE__ */ l({
	exportSolidityCallData: () => kr,
	fullProve: () => xr,
	prove: () => sn,
	verify: () => Cr
});
...
function Mr(e, t, n, r, i) {
	...
	return a.update(c), jr(e, a.digest());
}
function Nr(e, t, n, r, i) {
	return e.g1_s = t.G1.toAffine(t.G1.fromRng(i)), e.g1_sx = t.G1.toAffine(t.G1.timesFr(e.g1_s, e.prvKey)), e.g2_sp = t.G2.toAffine(Mr(t, n, r, e.g1_s, e.g1_sx)), e.g2_spx = t.G2.toAffine(t.G2.timesFr(e.g2_sp, e.prvKey)), e;
}
function Pr(e, t, n) {
	let r = {
		tau: {},
	...
	return r.tau.prvKey = e.Fr.fromRng(n), r.alpha.prvKey = e.Fr.fromRng(n), r.beta.prvKey = e.Fr.fromRng(n), Nr(r.tau, e, 0, t, n), Nr(r.alpha, e, 1, t, n), Nr(r.beta, e, 2, t, n), r;
}
//#endregion
//#region src/powersoftau_utils.js
async function Fr(e, t, n, i) {
...
async function Lr(e, t, n) {
	return Rr(await e.read(t.F1.n8 * 2 * 6 + t.F2.n8 * 2 * 3), 0, t, n);
}
function Rr(e, t, n, r) {
	let i = {
		tau: {},
...
async function Br(e, t, n, r) {
	...
	zr(i, 0, t, n, r), await e.write(i);
}
async function Vr(e, t) {
	let n = {};
	n.tauG1 = await c(), n.tauG2 = await l(), n.alphaG1 = await c(), n.betaG1 = await c(), n.betaG2 = await l(), n.key = await Lr(e, t, !0), n.partialHash = await e.read(216), n.nextChallenge = await e.read(64), n.type = await e.readULE32();
...
async function Ur(e, t, n) {
	...
	await o(n.tauG1), await s(n.tauG2), await o(n.alphaG1), await o(n.betaG1), await s(n.betaG2), await Br(e, t, n.key, !0), await e.write(n.partialHash), await e.write(n.nextChallenge), await e.writeULE32(n.type || 0);
	let a = [];
	if (n.name) {
		a.push(1);
		let e = new TextEncoder("utf-8").encode(n.name.substring(0, 64));
...
async function Wr(e, t, n) {
	...
	for (let r = 0; r < n.length; r++) await Ur(e, t, n[r]);
...
async function qr(e, t, n, r) {
	...
	await R(i, 2);
	let s = 2 ** t * 2 - 1;
	for (let e = 0; e < s; e++) await i.write(a), r && e % 1e5 == 0 && e && r.info("tauG1: " + e);
	await z(i), await R(i, 3);
	let c = 2 ** t;
	for (let e = 0; e < c; e++) await i.write(o), r && e % 1e5 == 0 && e && r.info("tauG2: " + e);
	await z(i), await R(i, 4);
	let l = 2 ** t;
	for (let e = 0; e < l; e++) await i.write(a), r && e % 1e5 == 0 && e && r.info("alphaTauG1: " + e);
	await z(i), await R(i, 5);
	let u = 2 ** t;
	for (let e = 0; e < u; e++) await i.write(a), r && e % 1e5 == 0 && e && r.info("betaTauG1: " + e);
...
async function Jr(e, t, n) {
	let { fd: r, sections: i } = await L(e, "ptau", 1), { curve: a, power: o } = await Ir(r, i), s = await Hr(r, a, i), c, l;
	s.length == 0 ? (c = K.create({ dkLen: 64 }).digest(), l = Gr(a, o)) : (c = s[s.length - 1].responseHash, l = s[s.length - 1].nextChallenge), n && n.info(q(c, "Last Response Hash: ")), n && n.info(q(l, "New Challenge Hash: "));
	let u = await lr(t), d = K.create({ dkLen: 64 });
...
async function Yr(e, t, n, r, i, a) {
	...
	let { fd: s, sections: c } = await L(e, "ptau", 1), { curve: l, power: u } = await Ir(s, c), d = await Hr(s, l, c), f = {};
	r && (f.name = r);
	let p = l.F1.n8 * 2, m = l.F1.n8, h = l.F2.n8 * 2, g = l.F2.n8, _ = await ur(t);
	if (_.totalSize != 64 + (2 ** u * 2 - 1) * m + 2 ** u * g + 2 ** u * m + 2 ** u * m + g + p * 6 + h * 3) throw Error("Size of the contribution is invalid");
	let v;
	v = d.length > 0 ? d[d.length - 1].nextChallenge : Gr(l, u, a);
	...
	f.key = Rr(w, 0, l, !1), x.update(new Uint8Array(w));
	let T = x.digest();
	...
	return d.push(f), await Wr(y, l, d), await _.close(), await y.close(), await s.close(), f.nextChallenge;
...
async function Zr(e, t, n, r) {
	...
	return t.key.tau.g2_sp = e.G2.toAffine(Mr(e, 0, n.nextChallenge, t.key.tau.g1_s, t.key.tau.g1_sx)), t.key.alpha.g2_sp = e.G2.toAffine(Mr(e, 1, n.nextChallenge, t.key.alpha.g1_s, t.key.alpha.g1_sx)), t.key.beta.g2_sp = e.G2.toAffine(Mr(e, 2, n.nextChallenge, t.key.beta.g1_s, t.key.beta.g1_sx)), i = await Xr(e, t.key.tau.g1_s, t.key.tau.g1_sx, t.key.tau.g2_sp, t.key.tau.g2_spx), i === !0 ? (i = await Xr(e, t.key.alpha.g1_s, t.key.alpha.g1_sx, t.key.alpha.g2_sp, t.key.alpha.g2_spx), i === !0 ? (i = await Xr(e, t.key.beta.g1_s, t.key.beta.g1_sx, t.key.beta.g2_sp, t.key.beta.g2_spx), i === !0 ? (i = await Xr(e, n.tauG1, t.tauG1, t.key.tau.g2_sp, t.key.tau.g2_spx), i === !0 ? (i = await Xr(e, t.key.tau.g1_s, t.key.tau.g1_sx, n.tauG2, t.tauG2), i === !0 ? (i = await Xr(e, n.alphaG1, t.alphaG1, t.key.alpha.g2_sp, t.key.alpha.g2_spx), i === !0 ? (i = await Xr(e, n.betaG1, t.betaG1, t.key.beta.g2_sp, t.key.beta.g2_spx), i === !0 ? (i = await Xr(e, t.key.beta.g1_s, t.key.beta.g1_sx, n.betaG2, t.betaG2), i === !0 ? (r && r.info("Powers Of tau file OK!"), !0) : (r && r.error("INVALID beta*G2. challenge #" + t.id + "It does not follow the previous contribution"), !1)) : (r && r.error("INVALID beta*G1. challenge #" + t.id + " It does not follow the previous contribution"), !1)) : (r && r.error("INVALID alpha*G1. challenge #" + t.id + " It does not follow the previous contribution"), !1)) : (r && r.error("INVALID tau*G2. challenge #" + t.id + " It does not follow the previous contribution"), !1)) : (r && r.error("INVALID tau*G1. challenge #" + t.id + " It does not follow the previous contribution"), !1)) : (r && r.error("INVALID key (beta) in challenge #" + t.id), !1)) : (r && r.error("INVALID key (alpha) in challenge #" + t.id), !1)) : (r && r.error("INVALID key (tau) in challenge #" + t.id), !1);
}
...
async function $r(n, r, i) {
	...
	i.fd = o;
	let { curve: c, power: l, ceremonyPower: u } = await Ir(o, s), d = await Hr(o, c, s);
	...
	let m = d[d.length - 1];
	if (r && r.debug("Validating contribution #" + d[d.length - 1].id), !await Zr(c, m, p, r)) return !1;
	...
	if (a = await Xr(c, g.R1, g.R2, c.G2.g, m.tauG2), a !== !0) return r && r.error("tauG1 section. Powers do not match"), !1;
	/* c8 ignore start */
	...
	if (a = await Xr(c, c.G1.g, m.tauG1, _.R1, _.R2), a !== !0) return r && r.error("tauG2 section. Powers do not match"), !1;
	/* c8 ignore start */
	...
	if (a = await Xr(c, v.R1, v.R2, c.G2.g, m.tauG2), a !== !0) return r && r.error("alphaTauG1 section. Powers do not match"), !1;
	/* c8 ignore start */
	...
	if (a = await Xr(c, y.R1, y.R2, c.G2.g, m.tauG2), a !== !0) return r && r.error("betaTauG1 section. Powers do not match"), !1;
	/* c8 ignore start */
...
async function ei(e, t, n, r, i, a, o, s, c, l) {
...
async function ti(e, t, n, r, i, a, o, s, c, l, u) {
...
async function ni(e, t, n, r, i) {
	let a = await ur(t), o = e.F1.n64 * 8 * 2, s = e.F2.n64 * 8 * 2, c = (a.totalSize + o - 64 - s) / (4 * o + s), l = c, u = 0;
	for (; l > 1;) l /= 2, u += 1;
	if (2 ** u != c) throw Error("Invalid file size");
	i && i.debug("Power to tau size: " + u);
	let d = await Pt(r), f = await lr(n), p = K.create({ dkLen: 64 });
	...
	await f.write(h), _.update(h), await ti(a, f, _, e, "G1", 2 ** u * 2 - 1, e.Fr.one, g.tau.prvKey, "COMPRESSED", "tauG1", i), await ti(a, f, _, e, "G2", 2 ** u, e.Fr.one, g.tau.prvKey, "COMPRESSED", "tauG2", i), await ti(a, f, _, e, "G1", 2 ** u, g.alpha.prvKey, g.tau.prvKey, "COMPRESSED", "alphaTauG1", i), await ti(a, f, _, e, "G1", 2 ** u, g.beta.prvKey, g.tau.prvKey, "COMPRESSED", "betaTauG1", i), await ti(a, f, _, e, "G2", 1, g.beta.prvKey, g.tau.prvKey, "COMPRESSED", "betaTauG2", i);
	let v = new Uint8Array(e.F1.n8 * 2 * 6 + e.F2.n8 * 2 * 3);
	zr(v, 0, e, g, !1), await f.write(v), _.update(v);
	let y = _.digest();
...
async function ri(e, t, n, r, i, a) {
	...
	let { fd: s, sections: c } = await L(e, "ptau", 1), { curve: l, power: u, ceremonyPower: d } = await Ir(s, c);
	...
	let f = await Hr(s, l, c), p = {
		name: n,
		type: 1,
		numIterationsExp: i,
		beaconHash: o
	}, m;
	m = f.length > 0 ? f[f.length - 1].nextChallenge : Gr(l, u, a), p.key = await Kr(l, m, o, i);
	let h = K.create({ dkLen: 64 });
	h.update(m);
	...
	zr(y, 0, l, p.key, !1), h.update(new Uint8Array(y));
	let b = h.digest();
	a && a.info(q(b, "Contribution Response Hash imported: "));
	let x = K.create({ dkLen: 64 });
	return x.update(b), await C(g, "G1", 2, 2 ** u * 2 - 1, "tauG1", a), await C(g, "G2", 3, 2 ** u, "tauG2", a), await C(g, "G1", 4, 2 ** u, "alphaTauG1", a), await C(g, "G1", 5, 2 ** u, "betaTauG1", a), await C(g, "G2", 6, 1, "betaG2", a), p.nextChallenge = x.digest(), a && a.info(q(p.nextChallenge, "Next Challenge Hash: ")), f.push(p), await Wr(g, l, f), await s.close(), await g.close(), b;
...
async function ii(e, t, n, r, i) {
	let { fd: a, sections: o } = await L(e, "ptau", 1), { curve: s, power: c, ceremonyPower: l } = await Ir(a, o);
	...
	let u = await Hr(a, s, o), d = {
		name: n,
		type: 0
	}, f, p = await Pt(r);
	f = u.length > 0 ? u[u.length - 1].nextChallenge : Gr(s, c, i), d.key = Pr(s, f, p);
	...
	zr(v, 0, s, d.key, !1), m.update(new Uint8Array(v));
	let y = m.digest();
	i && i.info(q(y, "Contribution Response Hash imported: "));
	let b = K.create({ dkLen: 64 });
	return b.update(y), await S(h, "G1", 2, 2 ** c * 2 - 1, "tauG1"), await S(h, "G2", 3, 2 ** c, "tauG2"), await S(h, "G1", 4, 2 ** c, "alphaTauG1"), await S(h, "G1", 5, 2 ** c, "betaTauG1"), await S(h, "G2", 6, 1, "betaG2"), d.nextChallenge = b.digest(), i && i.info(q(d.nextChallenge, "Next Challenge Hash: ")), u.push(d), await Wr(h, s, u), await a.close(), await h.close(), y;
...
async function ai(t, n, r) {
	let { fd: i, sections: a } = await L(t, "ptau", 1), { curve: o, power: s } = await Ir(i, a), c = await De(n, "ptau", 1, 11);
	await Fr(c, o, s), await H(i, a, c, 2), await H(i, a, c, 3), await H(i, a, c, 4), await H(i, a, c, 5), await H(i, a, c, 6), await H(i, a, c, 7), await l(2, 12, "G1", "tauG1"), await l(3, 13, "G2", "tauG2"), await l(4, 14, "G1", "alphaTauG1"), await l(5, 15, "G1", "betaTauG1"), await i.close(), await c.close();
	return;
...
async function oi(e, t, n) {
	let { fd: r, sections: i } = await L(e, "ptau", 1), { curve: a, power: o, ceremonyPower: s } = await Ir(r, i), c = a.G1.F.n8 * 2, l = a.G2.F.n8 * 2;
	...
	async function u(e) {
		...
		await Fr(u, a, e, s), await H(r, i, u, 2, (2 ** e * 2 - 1) * c), await H(r, i, u, 3, 2 ** e * l), await H(r, i, u, 4, 2 ** e * c), await H(r, i, u, 5, 2 ** e * c), await H(r, i, u, 6, l), await H(r, i, u, 7), await H(r, i, u, 12, (2 ** (e + 1) * 2 - 1) * c), await H(r, i, u, 13, (2 ** e * 2 - 1) * l), await H(r, i, u, 14, (2 ** e * 2 - 1) * c), await H(r, i, u, 15, (2 ** e * 2 - 1) * c), await u.close();
	}
}
//#endregion
//#region src/powersoftau_convert.js
async function si(t, n, r) {
	let { fd: i, sections: a } = await L(t, "ptau", 1), { curve: o, power: s } = await Ir(i, a), c = await De(n, "ptau", 1, 11);
	await Fr(c, o, s), await H(i, a, c, 2), await H(i, a, c, 3), await H(i, a, c, 4), await H(i, a, c, 5), await H(i, a, c, 6), await H(i, a, c, 7), await l(2, 12, "G1", "tauG1"), await H(i, a, c, 13), await H(i, a, c, 14), await H(i, a, c, 15), await i.close(), await c.close();
	return;
	async function l(t, n, l, u) {
		r && r.debug("Starting section: " + u), await R(c, n);
...
var di = 262144, fi = {
	...
	constructor(e) {
		this.length = e || 0, this.arr = Array(di);
		for (let t = 0; t < e; t += di) this.arr[t / di] = Array(Math.min(di, e - t));
		return this;
	}
	push() {
	...
	getElement(e) {
		e = parseInt(e);
		let t = Math.floor(e / di), n = e % di;
		return this.arr[t] ? this.arr[t][n] : void 0;
	}
	setElement(e, t) {
		e = parseInt(e);
		let n = Math.floor(e / di);
		this.arr[n] || (this.arr[n] = Array(di));
		let r = e % di;
		return this.arr[n][r] = t, e >= this.length && (this.length = e + 1), !0;
	}
	getKeys() {
		let e = new mi();
		for (let t = 0; t < this.arr.length; t++) if (this.arr[t]) for (let n = 0; n < this.arr[t].length; n++) this.arr[t][n] !== void 0 && e.push(t * di + n);
		return e;
	}
}, mi = class {
	constructor(e) {
		let t = new pi(e);
		return new Proxy(t, fi);
	}
};
...
async function vi(e, t, n) {
	...
	let r = await hi(e, t, n);
	return n.loadConstraints && (r.constraints = await gi(e, t, r, n)), n.loadMap && (r.map = await _i(e, t, r, n)), n.loadCustomGates && (r.useCustomGates ? (r.customGates = await bi(e, t, r), r.customGatesUses = await xi(e, t, n)) : (r.customGates = [], r.customGatesUses = [])), r;
}
async function yi(e, t, n, r, i, a) {
	...
	let { fd: s, sections: c } = await L(e, "r1cs", 1, 1 << 25, 1 << 22), l = await vi(s, c, o);
...
var Si = r.e("73eda753299d7d483339d80809a1d80553bda402fffe5bfeffffffff00000001", 16), Ci = r.e("21888242871839275222246405745257275088548364400416034343698204186575808495617");
async function wi(e, t) {
	let n = await yi(e, {
		loadConstraints: !1,
		loadMap: !1
	});
	return r.eq(n.prime, Ci) ? t && t.info("Curve: bn-128") : r.eq(n.prime, Si) ? t && t.info("Curve: bls12-381") : t && t.info(`Unknown Curve. Prime: ${r.toString(n.prime)}`), t && t.info(`# of Wires: ${n.nVars}`), t && t.info(`# of Constraints: ${n.nConstraints}`), t && t.info(`# of Private Inputs: ${n.nPrvInputs}`), t && t.info(`# of Public Inputs: ${n.nPubInputs}`), t && t.info(`# of Labels: ${n.nLabels}`), t && t.info(`# of Outputs: ${n.nOutputs}`), n;
}
//#endregion
//#region src/r1cs_export_json.js
async function Ti(e, t) {
	let n = await yi(e, !0, !0, !0, t), r = n.curve.Fr;
...
async function Di(e) {
	let t = {
		...
		varIdx2Name: ["one"],
		componentIdx2Name: []
	}, n = await ur(e), r = await n.read(n.totalSize), i = new TextDecoder("utf-8").decode(r).split("\n");
...
var { unstringifyBigInts: Oi } = s;
async function ki(e, t, n, r, i, a) {
	let o = Oi(e), s = await ur(t), c = await s.read(s.totalSize);
	await s.close();
	let l = {
		...i,
		sanityCheck: !0
	}, u = await Di(r);
	i.set && (u ||= await Di(r), l.logSetSignal = function(e, t) {
		a && a.info("SET " + u.labelIdx2Name[e] + " <-- " + t.toString());
	}), i.get && (u ||= await Di(r), l.logGetSignal = function(e, t) {
		a && a.info("GET " + u.labelIdx2Name[e] + " --> " + t.toString());
	}), i.trigger && (u ||= await Di(r), l.logStartComponent = function(e) {
		a && a.info("START: " + u.componentIdx2Name[e]);
	}, l.logFinishComponent = function(e) {
		a && a.info("FINISH: " + u.componentIdx2Name[e]);
	}), l.sym = u;
	let d = await hr(c, l), f = await d.calculateWitness(o, !0), p = await De(n, "wtns", 2, 2);
	await tn(p, f, d.prime), await p.close();
}
//#endregion
...
var Ni = /* @__PURE__ */ l({
	...
	constructor(e) {
		this.length = e || 0, this.arr = Array(Pi);
		for (let t = 0; t < e; t += Pi) this.arr[t / Pi] = Array(Math.min(Pi, e - t));
		return this;
	}
	push() {
		for (let e = 0; e < arguments.length; e++) this.setElement(this.length, arguments[e]);
	...
	getElement(e) {
		e = parseInt(e);
		let t = Math.floor(e / Pi), n = e % Pi;
		return this.arr[t] ? this.arr[t][n] : void 0;
	}
	setElement(e, t) {
		e = parseInt(e);
		let n = Math.floor(e / Pi);
		this.arr[n] || (this.arr[n] = Array(Pi));
		let r = e % Pi;
		return this.arr[n][r] = t, e >= this.length && (this.length = e + 1), !0;
	}
	getKeys() {
		let e = new Li();
		for (let t = 0; t < this.arr.length; t++) if (this.arr[t]) for (let n = 0; n < this.arr[t].length; n++) this.arr[t][n] !== void 0 && e.push(t * Pi + n);
		return e;
	}
}, Li = class {
	constructor(e) {
...
async function zi(t, n, i, a, o) {
	let s = K.create({ dkLen: 64 }), { fd: c, sections: l } = await L(n, "ptau", 1, 1 << 22, 1 << 24);
	o.fdPTau = c;
	let { curve: u, power: d } = await Ir(c, l), { fd: f, sections: p } = await L(t, "r1cs", 1, 1 << 22, 1 << 24);
	o.fdR1cs = f;
	let m = await hi(f, p, !1), h = await De(i, "zkey", 1, 10, 1 << 22, 1 << 24);
	o.fdZKey = h;
	...
	let D = await U(f, p, 2);
	await f.close();
	let O = new Li(m.nVars), k = new Li(m.nVars), A = new Li(m.nVars), j = new Li(m.nVars - y - 1), M = Array(y + 1);
...
async function Bi(e, t, n) {
	let { fd: r, sections: i } = await L(e, "zkey", 2), a = await Ut(r, i);
	if (a.protocol != "groth16") throw Error("zkey file is not groth16");
	let o = await Le(a.q), s = o.G1.F.n8 * 2, c = o.G2.F.n8 * 2, l = await Yt(r, o, i), u = await lr(t);
...
async function Hi(e, t, n, r, i, a) {
	...
	a.fdZKeyOld = o;
	let c = await Ut(o, s, !1);
	if (c.protocol != "groth16") throw Error("zkey file is not groth16");
	let l = await Le(c.q), u = l.G1.F.n8 * 2, d = l.G2.F.n8 * 2, f = await Yt(o, l, s), p = {}, m = await ur(t);
	...
	/* c8 ignore start */
	if (a.fdZKeyNew = g, m.pos = 0, m.pos += u, m.pos += u, m.pos += d, m.pos += d, c.vk_delta_1 = await C(m), c.vk_delta_2 = await w(m), await zt(g, c), await m.readUBE32() != c.nPublic + 1) return i && i.error("Invalid number of points in IC"), await g.discard(), !1;
	/* c8 ignore start */
	...
	return m.pos += d * c.nVars, await H(o, s, g, 7), await Zt(g, l, p), await m.close(), await g.close(), await o.close(), !0;
	async function C(e) {
...
/* c8 ignore stop */ var Ui = kt;
async function Wi(e, t, n, r) {
	let i = {};
	try {
		return await Gi(e, t, n, r, i);
	} finally {
		for (let e of [
			i.fd,
			i.fdInit,
...
async function Gi(n, i, a, o, s) {
	let c, { fd: l, sections: u } = await L(a, "zkey", 2);
	s.fd = l;
	let d = await Ut(l, u, !1);
	if (d.protocol != "groth16") throw Error("zkey file is not groth16");
	let f = await Le(d.q), p = f.G1.F.n8 * 2, m = await Yt(l, f, u), h = K.create({ dkLen: 64 });
	h.update(m.csHash);
	let g = f.G1.g;
	for (let e = 0; e < m.contributions.length; e++) {
		let t = m.contributions[e], n = Et(h);
		/* c8 ignore start */
		if (Qt(n, f, t.delta.g1_s), Qt(n, f, t.delta.g1_sx), !Tt(n.digest(), t.transcript)) return console.log(`INVALID(${e}): Inconsistent transcript `), !1;
		/* c8 ignore stop */
		let r = jr(f, t.transcript);
		/* c8 ignore start */
		if (c = await Ui(f, t.delta.g1_s, t.delta.g1_sx, r, t.delta.g2_spx), c !== !0) return console.log(`INVALID(${e}): public key G1 and G2 do not have the same ration `), !1;
		/* c8 ignore start */
		if (c = await Ui(f, g, t.deltaAfter, r, t.delta.g2_spx), c !== !0) return console.log(`INVALID(${e}): deltaAfter does not fillow the public key `), !1;
		/* c8 ignore stop */
		if (t.type == 1) {
		...
		en(i, f, t), t.contributionHash = i.digest(), g = t.deltaAfter;
	}
	let { fd: _, sections: v } = await L(n, "zkey", 2);
	s.fdInit = _;
	let y = await Ut(_, v, !1);
	...
	if (c = await Ui(f, f.G1.g, g, f.G2.g, d.vk_delta_2), c !== !0) return o && o.error("INVALID:  Invalid delta2"), !1;
	let b = await Yt(_, f, v);
	...
	async function C() {
		...
		return await V(l), c = await Ui(f, b, C, d.vk_delta_2, y.vk_delta_2), c === !0;
	}
...
async function Ki(e, t, n, r) {
	let i = { type: "bigMem" };
	return await Ri(e, t, i, r), await Wi(i, t, n, r);
}
//#endregion
//#region src/zkey_contribute.js
async function qi(e, t, n, r, i) {
	let { fd: a, sections: o } = await L(e, "zkey", 2), s = await Ut(a, o);
	if (s.protocol != "groth16") throw Error("zkey file is not groth16");
	let c = await Le(s.q), l = await Yt(a, c, o), u = await De(t, "zkey", 1, 10), d = await Pt(r), f = K.create({ dkLen: 64 });
	f.update(l.csHash);
	for (let e = 0; e < l.contributions.length; e++) en(f, c, l.contributions[e]);
	let p = {};
	p.delta = {}, p.delta.prvKey = c.Fr.fromRng(d), p.delta.g1_s = c.G1.toAffine(c.G1.fromRng(d)), p.delta.g1_sx = c.G1.toAffine(c.G1.timesFr(p.delta.g1_s, p.delta.prvKey)), Qt(f, c, p.delta.g1_s), Qt(f, c, p.delta.g1_sx), p.transcript = f.digest(), p.delta.g2_sp = jr(c, p.transcript), p.delta.g2_spx = c.G2.toAffine(c.G2.timesFr(p.delta.g2_sp, p.delta.prvKey)), s.vk_delta_1 = c.G1.timesFr(s.vk_delta_1, p.delta.prvKey), s.vk_delta_2 = c.G2.timesFr(s.vk_delta_2, p.delta.prvKey), p.deltaAfter = s.vk_delta_1, p.type = 0, n && (p.name = n), l.contributions.push(p), await zt(u, s), await H(a, o, u, 3), await H(a, o, u, 4), await H(a, o, u, 5), await H(a, o, u, 6), await H(a, o, u, 7);
	let m = c.Fr.inv(p.delta.prvKey);
	await ei(a, o, u, 8, c, "G1", m, c.Fr.e(1), "L Section", i), await ei(a, o, u, 9, c, "G1", m, c.Fr.e(1), "H Section", i), await Zt(u, c, l), await a.close(), await u.close();
	let h = K.create({ dkLen: 64 });
	en(h, c, p);
	let g = h.digest();
...
async function Ji(e, t, n, r, i, a) {
	...
	if (o.length >= 256) return a && a.error("Maximum length of beacon hash is 255 bytes"), !1;
	if (i = parseInt(i), i < 10 || i > 63) return a && a.error("Invalid numIterationsExp. (Must be between 10 and 63)"), !1;
	let { fd: s, sections: c } = await L(e, "zkey", 2), l = await Ut(s, c);
	if (l.protocol != "groth16") throw Error("zkey file is not groth16");
	let u = await Le(l.q), d = await Yt(s, u, c), f = await De(t, "zkey", 1, 10), p = await Ft(o, i), m = K.create({ dkLen: 64 });
	m.update(d.csHash);
	for (let e = 0; e < d.contributions.length; e++) en(m, u, d.contributions[e]);
	let h = {};
	h.delta = {}, h.delta.prvKey = u.Fr.fromRng(p), h.delta.g1_s = u.G1.toAffine(u.G1.fromRng(p)), h.delta.g1_sx = u.G1.toAffine(u.G1.timesFr(h.delta.g1_s, h.delta.prvKey)), Qt(m, u, h.delta.g1_s), Qt(m, u, h.delta.g1_sx), h.transcript = m.digest(), h.delta.g2_sp = jr(u, h.transcript), h.delta.g2_spx = u.G2.toAffine(u.G2.timesFr(h.delta.g2_sp, h.delta.prvKey)), l.vk_delta_1 = u.G1.timesFr(l.vk_delta_1, h.delta.prvKey), l.vk_delta_2 = u.G2.timesFr(l.vk_delta_2, h.delta.prvKey), h.deltaAfter = l.vk_delta_1, h.type = 1, h.numIterationsExp = i, h.beaconHash = o, n && (h.name = n), d.contributions.push(h), await zt(f, l), await H(s, c, f, 3), await H(s, c, f, 4), await H(s, c, f, 5), await H(s, c, f, 6), await H(s, c, f, 7);
	let g = u.Fr.inv(h.delta.prvKey);
	await ei(s, c, f, 8, u, "G1", g, u.Fr.e(1), "L Section", a), await ei(s, c, f, 9, u, "G1", g, u.Fr.e(1), "H Section", a), await Zt(f, u, d), await s.close(), await f.close();
	let _ = K.create({ dkLen: 64 });
	en(_, u, h);
	let v = _.digest();
...
async function Xi(e, t, n, r, i) {
	let a = await Pt(r), o = e.Fr.fromRng(a), s = e.Fr.inv(o), c = e.G1.F.n8 * 2, l = e.G2.F.n8 * 2, u = await ur(t), d = await lr(n);
	...
	await d.writeUBE32(g), await ti(u, d, null, e, "G1", g, s, e.Fr.e(1), "UNCOMPRESSED", "H", i);
	let _ = await u.readUBE32();
	await d.writeUBE32(_), await ti(u, d, null, e, "G1", _, s, e.Fr.e(1), "UNCOMPRESSED", "L", i);
...
async function Qi(e, t) {
	...
	let { fd: n, sections: r } = await L(e, "zkey", 2), i = await Ut(n, r);
	t && t.info("> Detected protocol: " + i.protocol);
	let a;
	if (i.protocol === "groth16") a = await $i(i, n, r);
	else if (i.protocol === "plonk") a = await ea(i);
	else if (i.protocolId && i.protocolId === 10) a = await ta(i, t);
...
var na = /* @__PURE__ */ l({
	beacon: () => Ji,
	bellmanContribute: () => Xi,
	contribute: () => qi,
	exportBellman: () => Bi,
	exportJson: () => Yi,
	exportSolidityVerifier: () => null,
	exportVerificationKey: () => Qi,
	importBellman: () => Vi,
	newZKey: () => Ri,
	verifyFromInit: () => Wi,
	verifyFromR1cs: () => Ki
...
async function ia(t, n, i, a, o) {
	globalThis.gc && globalThis.gc();
	let { fd: s, sections: c } = await L(n, "ptau", 1, 1 << 22, 1 << 24);
	o.fdPTau = s;
	let { curve: l, power: u } = await Ir(s, c), { fd: d, sections: f } = await L(t, "r1cs", 1, 1 << 22, 1 << 24);
	o.fdR1cs = d;
	let p = await vi(d, f, {
		loadConstraints: !0,
		loadCustomGates: !0
	...
	let y = new Li(), b = new Li(), x, S, C = p.nVars, w = p.nOutputs + p.nPubInputs;
 ...
 /* c8 ignore start */
	...
	async function te(t, n) {
		let r = new e(v * D * 3), i = new Li(C), o = new Li(C), s = _.one;
...
}, oa = BigInt(0), sa = BigInt(1), ca = BigInt(2), la = BigInt(7), ua = BigInt(256), da = BigInt(113), fa = [], pa = [], ma = [];
for (let e = 0, t = sa, n = 1, r = 0; e < 24; e++) {
	[n, r] = [r, (2 * n + 3 * r) % 5], fa.push(2 * (5 * r + n)), pa.push((e + 1) * (e + 2) / 2 % 64);
	let i = oa;
	for (let e = 0; e < 7; e++) t = (t << sa ^ (t >> la) * da) % ua, t & ca && (i ^= sa << (sa << BigInt(e)) - sa);
	ma.push(i);
}
var ha = nt(ma, !0), ga = ha[0], _a = ha[1], va = (e, t, n) => n > 32 ? dt(e, t, n) : lt(e, t, n), ya = (e, t, n) => n > 32 ? ft(e, t, n) : ut(e, t, n);
function ba(e, t = 24) {
	...
	for (let r = 24 - t; r < 24; r++) {
		...
		for (let t = 0; t < 10; t += 2) {
			let r = (t + 8) % 10, i = (t + 2) % 10, a = n[i], o = n[i + 1], s = va(a, o, 1) ^ n[r], c = ya(a, o, 1) ^ n[r + 1];
			for (let n = 0; n < 50; n += 10) e[t + n] ^= s, e[t + n + 1] ^= c;
		}
		let t = e[2], i = e[3];
		for (let n = 0; n < 24; n++) {
			let r = pa[n], a = va(t, i, r), o = ya(t, i, r), s = fa[n];
...
var xa = class e {
	...
	keccak() {
		Xe(this.state32), ba(this.state32, this.rounds), Xe(this.state32), this.posOut = 0, this.pos = 0;
	}
	update(e) {
		He(this), Ve(e);
...
}, Sa = /* @__PURE__ */ ((e, t, n, r = {}) => Ze(() => new xa(t, e, n), r))(1, 136, 32), Ca = 0, wa = 1, Ta = class {
	constructor(e) {
	...
	getChallenge() {
		...
		let e = 0, t = 0;
		this.data.forEach((n) => Ca === n.type ? e++ : t++);
		let n = new Uint8Array(t * this.Fr.n8 + e * this.G1.F.n8 * 2), i = 0;
		for (let e = 0; e < this.data.length; e++) Ca === this.data[e].type ? (this.G1.toRprUncompressed(n, i, this.data[e].data), i += this.G1.F.n8 * 2) : (this.Fr.toRprBE(n, i, this.data[e].data), i += this.Fr.n8);
		let a = r.fromRprBE(Sa(n));
		return this.Fr.e(a);
	}
}, Ea = class {
	static getZ1(e) {
...
}, { stringifyBigInts: Da } = s;
async function Oa(e, t, n, r) {
	let i = {};
	try {
		return await ka(e, t, n, r, i);
	} finally {
...
async function ka(t, n, i, a, o) {
	...
	let _ = await U(s, c, 2);
	_.set(m.zero, 0);
	let v = new e(h * f.nAdditions), y = {}, b = {}, x = {}, S = {}, C = new aa(p, i), w = new Ta(p);
	...
	async function I() {
		...
		for (let e = 0; e < f.domainSize * 4; e++) {
			...
			let ee = o, [te, ne] = Ea.mul4(P, F, I, ee, b, C, w, E, e % 4, m);
			...
			let oe = s, [se, ce] = Ea.mul4(re, ie, ae, oe, b, C, w, k, e % 4, m);
...
var { unstringifyBigInts: Aa } = s;
async function ja(e, t, n, r, i, a) {
	let o = Aa(e), s = { type: "mem" };
	return await yr(o, t, s, i), await Oa(n, s, r, a);
}
//#endregion
//#region src/plonk_verify.js
var { unstringifyBigInts: Ma } = s;
async function Na(e, t, n, r) {
	let i = Ma(e);
	n = Ma(n);
	let a = Ma(t), o = await Re(i.curve), s = o.Fr, c = o.G1;
	r && r.info("PLONK VERIFIER STARTED");
	let l = Pa(o, n);
	if (i = Fa(o, i), !Ia(o, l)) return r && r.error("Proof commitments are not valid."), !1;
	if (a.length != i.nPublic) return r && r.error("Invalid number of public inputs"), !1;
	if (!za(o, l)) return r && r.error("Proof evaluations are not valid"), !1;
	if (!Ba(o, a)) return r && r.error("Public inputs are not valid."), !1;
	let u = Va(o, l, a, i);
	if (r) {
...
function Ra(e, t) {
	return La(e, r.fromRprLE(t));
}
function za(e, t) {
	return Ra(e, t.eval_a) && Ra(e, t.eval_b) && Ra(e, t.eval_c) && Ra(e, t.eval_s1) && Ra(e, t.eval_s2) && Ra(e, t.eval_zw);
}
function Ba(e, t) {
	for (let n = 0; n < t.length; n++) if (!La(e, t[n])) return !1;
	return !0;
}
function Va(e, t, n, r) {
	let i = e.Fr, a = {}, o = new Ta(e);
...
var to = 0, no = 1, ro = 2, io = class {
	...
	processR1csConstraint(e, t, n, r) {
		...
		if (i === to || a === to) return this.processR1csAdditionConstraint(e, r);
		if (i === no) {
			/* c8 ignore start */
...
async function so(t, n, i, a, o) {
	...
	async function k(e, t, n) {
		for (let t = 0; t < b.nPublic; t++) x.push(Qa(t + 1, e));
		let r = new io(e, Qa, $a, eo, n), i = await U(u, d, 2), a = 0;
 ...
 /* c8 ignore start */
	...
	async function F(t) {
		let n = new e(m * b.domainSize * 3), r = new Li(b.nVars), i = new Li(b.nVars), o = p.one;
...
async function uo(t, n, i, a, o) {
	...
	let y = new e(f.nAdditions * h), b = {}, x = {}, S = {}, C = {}, w = {}, T = {}, E = new aa(p, i);
...
var { unstringifyBigInts: fo } = s;
async function po(e, t, n, r, i, a) {
	let o = fo(e), s = { type: "mem" };
	return await yr(o, t, s, i), await lo(n, s, r, a);
}
//#endregion
//#region src/fflonk_verify.js
var { unstringifyBigInts: mo } = s;
async function ho(e, t, n, r) {
	r && r.info("FFLONK VERIFIER STARTED"), e = mo(e), n = mo(n);
	let i = await Re(e.curve), a = go(i, e), o = new aa(i, r);
	o.fromObjectProof(n);
	let s = mo(t);
	if (s.length !== a.nPublic) return r && r.error("Number of public signals does not match with vk"), !1;
	let c = i.Fr;
	if (r && (r.info("----------------------------"), r.info("  FFLONK VERIFY SETTINGS"), r.info(`  Curve:         ${i.name}`), r.info(`  Circuit power: ${a.power}`), r.info(`  Domain size:   ${2 ** a.power}`), r.info(`  Public vars:   ${a.nPublic}`), r.info("----------------------------")), r && r.info("> Checking commitments belong to G1"), !_o(i, o, a)) return r && r.error("Proof commitments are not valid"), !1;
	if (r && r.info("> Checking evaluations belong to F"), !bo(i, o)) return r && r.error("Proof evaluations are not valid."), !1;
	if (r && r.info("> Checking public inputs belong to F"), !xo(i, s)) return r && r.error("Public inputs are not valid."), !1;
	r && r.info("> Computing challenges");
	let { challenges: l, roots: u } = So(i, o, a, s, r);
...
function yo(e, t) {
	return vo(e, r.fromRprLE(t));
}
function bo(e, t) {
	return yo(e, t.evaluations.ql) && yo(e, t.evaluations.qr) && yo(e, t.evaluations.qm) && yo(e, t.evaluations.qo) && yo(e, t.evaluations.qc) && yo(e, t.evaluations.s1) && yo(e, t.evaluations.s2) && yo(e, t.evaluations.s3) && yo(e, t.evaluations.a) && yo(e, t.evaluations.b) && yo(e, t.evaluations.c) && yo(e, t.evaluations.z) && yo(e, t.evaluations.zw) && yo(e, t.evaluations.t1w) && yo(e, t.evaluations.t2w);
}
function xo(e, t) {
	for (let n = 0; n < t.length; n++) if (!vo(e, t[n])) return !1;
	return !0;
}
function So(e, t, n, r, i) {
	let a = e.Fr, o = {}, s = {}, c = new Ta(e);
...
function To(e, t, n, r, i) {
	let a = r.Fr, o = Mo(n.S0.h0w8, t.y, t.xi, r);
...
function Eo(e, t, n, r, i, a) {
	let o = i.Fr, s = Mo(n.S1.h1w4, t.y, t.xi, i);
...
function Do(e, t, n, r, i, a, o) {
	let s = a.Fr, c = No([n.S2.h2w3, n.S2.h3w3], t.y, t.xi, t.xiw, a);
...
async function jo(e, t, n, r, i, a, o) {
...
//#endregion
export { je as curves, Io as fflonk, Ar as groth16, Za as plonk, li as powersOfTau, Ei as r1cs, Ni as wtns, na as zKey };
